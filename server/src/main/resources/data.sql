...
# flights
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (1, '2021-04-26 18:43:00', '2021-04-26 15:10:00', 'RF821', 'ожидает', 'Boeing 737-800', 'вылет', 1);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (2, '2021-04-26 16:10:00', '2021-04-26 14:30:00', 'RF822', 'ожидает', 'Boeing 737-800', 'вылет', 2);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (3, '2021-04-26 10:10:00', '2021-04-26 08:00:00', 'S7 2504', 'ожидает', 'Boeing-787', 'вылет', 3);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (4, '2021-04-25 10:52:00', '2021-04-25 07:16:00', 'EY 8651', 'Прибыл', 'Airbus 321', 'вылет', 11);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (5, '2021-04-25 13:52:00', '2021-04-25 11:35:00', 'S7 3751', 'Прибыл', 'Airbus 321', 'вылет', 8);
...
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (11, '2021-04-26 09:30:00', '2021-04-26 07:03:00', 'RF820', 'ожидает', 'Boeing 737-800', 'прилет', 1);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (12, '2021-04-26 18:00:00', '2021-04-26 15:00:00', 'S7 2502', 'ожидает', 'Boeing 737-800', 'прилет', 4);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (13, '2021-04-26 08:40:00', '2021-04-26 04:45:00', 'B2 134', 'ожидает', 'Boeing 737-800', 'прилет', 5);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (14, '2021-04-25 08:48:00', '2021-04-25 02:36:00', 'S7 3032', 'Прибыл', '32N', 'прилет', 10);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (15, '2021-04-25 10:08:00', '2021-04-25 05:34:00', 'Y7 106', 'Прибыл', 'Boeing 737-300', 'прилет', 10);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (16, '2021-04-25 10:32:00', '2021-04-25 07:02:00', 'S7 2618', 'Прибыл', 'Airbus 320-200', 'прилет', 9);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (17, '2021-04-25 10:02:00', '2021-04-25 09:06:00', 'S7 1204', 'Прибыл', 'Embraer ERJ-170', 'прилет', 9);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (18, '2021-04-25 10:39:00', '2021-04-25 06:06:00', 'EY 8659', 'Прибыл', 'Boeing 737-800', 'прилет', 11);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (19, '2021-04-25 10:33:00', '2021-04-25 07:23:00', 'EK 7826', 'Прибыл', 'Airbus 321', 'прилет', 33);
insert into flights (flight_id, arrival_date, departure_date, flight_number, status, plane_model, type, route_id) values (20, '2021-04-26 08:30:00', '2021-04-26 06:30:00', 'RA709', 'ожидает', 'Boeing-787', 'прилет', 2);
